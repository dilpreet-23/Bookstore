  ...
  return (
    ...
    <div className=" max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col my-10 md:flex-row">
      ...
      <h1 className= "text-4xl font-bold">
        ...
        Borrow from wide collection of novels,textbooks,and classics
        at your convenience.Enjoy flexible return dates and easy renewals!
        </p>
        ...
        <button className="btn btn-active btn-secondary mt-6 md:mb-20">Get Started!</button>
        </div>
